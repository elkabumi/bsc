            ...
            <a href="../index.php" class="logo" >
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                  ...
                  <td width="86%" align="center"><span style="font-size:12px; font-weight:bold; color:#0FF">SITE SURVEY</span><br><span style="font-weight:bold; font-size:16px">DETAIL REPORT </span></td>
              </tr>
              </tr>
            </table>
