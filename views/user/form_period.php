                                      ...
                                      <!-- <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          <label>Type</label>
                                           ...
                                           <?php
                                          $query_type = mysql_query("select * from user_types order by user_type_id");
                                          while($row_type = mmysql_fetch_array($query_type)){
                                           ?>
                                             <option value="1"><?= $row_type['user_type_name'] ?></option>
                                             <?php
                                              }
                                             ?>
                                           </select>                                    
